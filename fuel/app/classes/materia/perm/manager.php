...
class Perm_Manager
{
	...
	/**
	 * Checks if the currently logged in user is a support user
	 *
	 * @return boolean whether or not the current user has the support user role as defined by the Perm_Role class
	 */
